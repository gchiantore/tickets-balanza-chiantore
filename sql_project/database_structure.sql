...
CREATE TABLE BALANZA.TICKETS (
    ...
    CHASIS VARCHAR(9) NOT NULL COMMENT 'Patente o Dominio del chasis del transporte',
    ACOPLADO VARCHAR(9) COMMENT 'Patente o Dominio del acoplado, puede ser nulo',
...
-- TABLA TICKETS_DE_OPERADORES ELIMINADOS

CREATE TABLE BALANZA.TICKETS_USUARIOS_ELIMINADOS (
    IDLOG INT PRIMARY KEY AUTO_INCREMENT,
    IDTICKET INT NOT NULL,
    IDOPERARIO INT NOT NULL,
    NOMBRE_OPERARIO VARCHAR(100) NOT NULL,
    FECHA_ELIMINACION DATETIME DEFAULT CURRENT_TIMESTAMP
) COMMENT 'Registra los tickets y datos del operario eliminado';
